            ...
            <div class="tile shadow">
                ...
                <form method="post" action="{{ route('admin.admins.store') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="first_name" autofocus class="form-control" value="{{ old('first_name') }}" required>
                    </div>

                    {{--last name--}}
                    <div class="form-group">
                        <label>{{__('Last Name')}} <span class="text-danger">*</span></label>
                        <input type="text" name="last_name" autofocus class="form-control" value="{{ old('last_name') }}" required>
                    </div>
                    ...
                    {{--role_id--}}
                    <div class="form-group">
                        <label>{{__('Choose role')}}<span class="text-danger">*</span></label>
