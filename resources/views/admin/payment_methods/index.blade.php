...
{{--                            <a href="{{ route('admin.payment-methods.create') }}" class="btn btn-primary"><i--}}
{{--                                    class="fa fa-plus"></i>--}}
{{--                                {{__('Create')}}</a>--}}
{{--                        @endif--}}

{{--                        @if (auth()->user()->hasPermission('delete_payment_methods'))--}}
{{--                            <form method="post" action="{{ route('admin.payment-methods.bulk_delete') }}"--}}
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table datatable" id="paymentMethods-table" style="width: 100%;">
                                <thead>
                                <tr>
                                    <th>
...
@push('scripts')
    ...
    <script>
        ...
        let paymentMethodsTable = $('#paymentMethods-table').DataTable({
            dom: "tiplr",
            serverSide: true,
            processing: true,
            "language": {
        ...
        $('#data-table-search').keyup(function () {
            paymentMethodsTable.search(this.value).draw();
        })
    </script>
