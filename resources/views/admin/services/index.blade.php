                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-12">
                        ...
                        @if (auth()->user()->hasPermission('create_services'))
                            <a href="{{ route('admin.services.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i>
                                {{__('Create')}}</a>
                        @endif
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table datatable" id="services-table" style="width: 100%;">
                                <thead>
                                <tr>
                                    <th>
...
@push('scripts')
    ...
    <script>
        ...
        let aqarTypesTable = $('#services-table').DataTable({
            dom: "tiplr",
            serverSide: true,
            processing: true,
            "language": {
