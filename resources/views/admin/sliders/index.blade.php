...
@section('content')
    ...
    <ul class="breadcrumb mt-2">
        ...
        <li class="breadcrumb-item">{{__('Sliders')}}</li>
    </ul>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-12">
                        ...
                        @if (auth()->user()->hasPermission('create_sliders'))
                            <a href="{{ route('admin.sliders.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i>
                                {{__('Create')}}</a>
                        @endif
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table datatable" id="sliders-table" style="width: 100%;">
                                <thead>
                                <tr>
                                    <th>
...
@push('scripts')
    ...
    <script>
        ...
        let aqarTypesTable = $('#sliders-table').DataTable({
            dom: "tiplr",
            serverSide: true,
            processing: true,
            "language": {
