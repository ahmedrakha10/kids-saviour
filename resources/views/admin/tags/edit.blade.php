...
@section('content')
    ...
    <ul class="breadcrumb mt-2">
        ...
        <li class="breadcrumb-item"><a href="{{ route('admin.tags.index') }}">{{__('Tags')}}</a></li>
            ...
            <div class="tile shadow">
                ...
                <form method="post" action="{{ route('admin.tags.update', $tag->id) }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name[ar]" class="form-control" value="{{ $tag->getOriginal('name')['ar'] }}" required
                               autofocus>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name[en]" class="form-control" value="{{ $tag->getOriginal('name')['en'] }}" required
                               autofocus>
                    </div>
