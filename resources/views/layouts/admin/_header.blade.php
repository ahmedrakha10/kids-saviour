...
<header class="app-header"><a class="app-header__logo" style="font-family: 'Cairo', 'sans-serif';"
                              href="{{ route('admin.home') }}">{{setting('title.'.app()->getLocale())}}</a>
    ...
    <ul class="app-nav">
                           ...
                           href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}">
                            @if(app()->getLocale() == 'ar')
                                ...
                                @if($properties['native'] == 'العربية')
                                    <img width="20px" src="{{asset('admin_assets/images/egypt.png')}}">
                                @else
                                    <img width="20px" src="{{asset('admin_assets/images/english.jpg')}}">
                                @endif
                            @else
        ...
        <li class="dropdown"><a class="app-nav__item" href="#" data-toggle="dropdown" aria-label="Open Profile Menu"><i
            ...
            <ul class="dropdown-menu settings-menu dropdown-menu-right">
                <li style="margin-{{app()->getLocale() == 'ar' ? 'left' : 'right'}}: 23px;"><a class="dropdown-item"
                                                                                               href="{{route('admin.settings.general')}}"><i
                            class="fa fa-cog fa-lg"></i> {{__('Settings')}}</a></li>
                <li><a class="dropdown-item" href="{{route('admin.profile.edit')}}"><i
                            class="fa fa-user fa-lg"></i> {{__('Profile')}}</a></li>
                <li>
